...
public class AnnonceWidgetController {
	...
	AnnonceController annnceCnt=new AnnonceController();
	
	@FXML
    private Pane AnnonceView;
    ...
    public void openAnnonceRUDStage() throws IOException {
    	 ...
    	 /*FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/UpdateAnnonce.fxml"));
         ...
         AnnonceView.getChildren().clear();
         //annoncesMainPane.getChildren().clear();
         AnnonceView.getChildren().add(nextPane);*/
